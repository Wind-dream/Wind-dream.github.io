...
function createtime() {
    ...
    let g = "";
    g = r < 18 && r >= 9 ? `<img class='boardsign' src='../../svg/上班打卡.svg' title='努努力，进阿里~'><span class='textTip'> <br> 本站居然运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>` : `<img class='boardsign' src='../../svg/下班学习.svg' title='下班了就该继续卷，哼~'><span class='textTip'> <br> 本站居然运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>`, document.getElementById("workboard") && (document.getElementById("workboard").innerHTML = g)
}
